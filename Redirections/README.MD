...
The list of redirections (`Redirections.csv`) is hosted here in CSV format so that it can be easily rendered in a table viewed on when GitHub and to simplify adding or updating the list.
