...
The list of redirections (`Redirections.csv`) is hosted here in CSV format so that it can be easily rendered in a table when viewed on GitHub and to simplify adding to or updating the list.
